  ...
  return (
    ...
    <section className="py-16 sm:py-24 md:py-32 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <CalendarCheck className="w-8 h-8 sm:w-10 sm:h-10 text-primary-foreground/80 mx-auto mb-4 sm:mb-6" />
          <h2 className="font-display text-2xl sm:text-4xl md:text-5xl font-semibold text-primary-foreground mb-4 sm:mb-6">
            Prêt(e) à commencer votre transformation ?
          </h2>
          <p className="font-body text-base sm:text-lg text-primary-foreground/80 leading-relaxed mb-8 sm:mb-10">
            Réservez votre première séance découverte et commençons ensemble votre parcours vers un bien-être durable.
          </p>
          <Button
            size="lg"
            className="text-sm sm:text-base px-6 sm:px-10 py-5 sm:py-6 rounded-full font-body font-medium bg-primary-foreground text-primary hover:bg-primary-foreground/90 w-full sm:w-auto"
